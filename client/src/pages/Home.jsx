  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Diagnósticos CRESE</h1>
          <p className="text-sm text-gray-500 mt-1">Autodiagnóstico de la Norma CRESE 2025</p>
        </div>
      ...
      {showNew && (
        <div className="card p-6 mb-6 border-blue-100">
          <h2 className="text-sm font-semibold text-gray-900 mb-4">Nuevo Diagnóstico</h2>
      ...
      {diagnosticos.length === 0 && !showNew && (
        <div className="card p-12 text-center">
          ...
          <h3 className="text-base font-medium text-gray-900 mb-2">Sin diagnósticos</h3>
          <p className="text-sm text-gray-500 mb-6">Crea tu primer diagnóstico CRESE para comenzar la autoevaluación.</p>
          <button className="btn-primary" onClick={() => setShowNew(true)}>+ Nuevo diagnóstico</button>
        </div>
      )}
